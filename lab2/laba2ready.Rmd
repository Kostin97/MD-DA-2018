...
#Повторите вызов 4 раза. Полученные ответы отличаются от полученных ранее? ОТЛИЧАЮТСЯ Если да, почему? Потому что в функции имеется генератор случайной величины runif.
